    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <p class="mt-4 text-sm text-gray-500">
                    A lightweight self-hosted file storage and delivery platform for your images and documents.
                </p>
            </div>
            ...
            <div class="col-span-1">
                ...
                <ul class="mt-4 space-y-4">
                    <li>
                        <a href="dashboard.php" class="text-base text-gray-500 hover:text-gray-900">Dashboard</a>
                    </li>
                    <li>
                        <a href="api-docs.php" class="text-base text-gray-500 hover:text-gray-900">API Documentation</a>
                    </li>
                    <li>
        ...
        <div class="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                &copy; <?= date('Y') ?> Mini Cloudinary. All rights reserved.
            </p>
        </div>
    </div>
</footer>